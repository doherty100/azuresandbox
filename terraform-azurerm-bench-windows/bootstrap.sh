...
default_app_subnet_id=$(terraform output -state="../terraform-azurerm-vnet-spoke/terraform.tfstate" vnet_spoke_01_app_subnet_id)
default_db_subnet_id=$(terraform output -state="../terraform-azurerm-vnet-spoke/terraform.tfstate" vnet_spoke_01_db_subnet_id)
...
vm_app_post_deploy_script_uri="https://$default_storage_account_name.blob.core.windows.net/$default_blob_storage_container_name/$vm_app_post_deploy_script"
vm_db_post_deploy_script_uri="https://$default_storage_account_name.blob.core.windows.net/$default_blob_storage_container_name/$vm_db_post_deploy_script"
vm_db_sql_startup_script_uri="https://$default_storage_account_name.blob.core.windows.net/$default_blob_storage_container_name/$vm_db_sql_startup_script"
...
az storage blob upload-batch \
    --account-name $default_storage_account_name \
