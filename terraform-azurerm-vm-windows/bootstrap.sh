...
az storage blob upload-batch --account-name $default_storage_account_name --account-key $default_storage_account_key --destination $default_blob_storage_container_name --source '.' --pattern '*.ps1'
