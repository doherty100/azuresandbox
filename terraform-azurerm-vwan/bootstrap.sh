...
default_vnets="${default_vnets}  $default_shared_virtual_network_name = \"$default_shared_virtual_network_id\",\n"
default_vnets="${default_vnets}  $default_spoke_virtual_network_name = \"$default_spoke_virtual_network_id\"\n"
default_vnets="${default_vnets}}"
